...
// Recipients
$fromEmail = 'alertas@repremar.com'; // Email address that will be in the from field of the message.
$fromName = 'Alertas'; // Name that will be in the from field of the message.
...
$smtpHost = 'smtp.office365.com'; // Enter SMTP host ie. smtp.gmail.com
$smtpUsername = 'alertas@premar.com'; // SMTP username ie. gmail address
$smtpPassword = 'Sol84186'; // SMTP password ie gmail password
